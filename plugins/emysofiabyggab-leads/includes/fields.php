...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'emysofiabyggab-leads' ),
				'storm'       => __( 'Storm or hail damage', 'emysofiabyggab-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'emysofiabyggab-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'emysofiabyggab-leads' ),
				'not-sure'    => __( 'Vet inte än', 'emysofiabyggab-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'emysofiabyggab-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'emysofiabyggab-leads' ),
				'research' => __( 'Jag kollar bara priser', 'emysofiabyggab-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'emysofiabyggab-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'emysofiabyggab-leads' ),
		'contacted' => __( 'Kontaktad', 'emysofiabyggab-leads' ),
		'quoted'    => __( 'Quote sent', 'emysofiabyggab-leads' ),
		'won'       => __( 'Won', 'emysofiabyggab-leads' ),
		'lost'      => __( 'Lost', 'emysofiabyggab-leads' ),
		'spam'      => __( 'Misstänkt spam', 'emysofiabyggab-leads' ),
	);
}
